...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/training-quiz-builder.zip)** (one zip, ready for Agent Builder) · Category: `learning-development` · Skill name: `training-quiz-builder`
