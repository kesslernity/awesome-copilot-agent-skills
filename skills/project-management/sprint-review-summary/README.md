...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/sprint-review-summary.zip)** (one zip, ready for Agent Builder) · Category: `project-management` · Skill name: `sprint-review-summary`
