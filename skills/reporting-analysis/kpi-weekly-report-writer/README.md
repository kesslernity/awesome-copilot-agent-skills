...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/kpi-weekly-report-writer.zip)** (one zip, ready for Agent Builder) · Category: `reporting-analysis` · Skill name: `kpi-weekly-report-writer`
