...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/policy-gap-review.zip)** (one zip, ready for Agent Builder) · Category: `security-grc` · Skill name: `policy-gap-review`
