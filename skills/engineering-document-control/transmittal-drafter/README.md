...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/transmittal-drafter.zip)** (one zip, ready for Agent Builder) · Category: `engineering-document-control` · Skill name: `transmittal-drafter`
