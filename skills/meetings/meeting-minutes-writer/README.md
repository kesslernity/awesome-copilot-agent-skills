...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/meeting-minutes-writer.zip)** (one zip, ready for Agent Builder) · Category: `meetings` · Skill name: `meeting-minutes-writer`
