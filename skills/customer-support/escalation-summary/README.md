...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/escalation-summary.zip)** (one zip, ready for Agent Builder) · Category: `customer-support` · Skill name: `escalation-summary`
