...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/ticket-triage-pack.zip)** (one zip, ready for Agent Builder) · Category: `customer-support` · Skill name: `ticket-triage-pack`
