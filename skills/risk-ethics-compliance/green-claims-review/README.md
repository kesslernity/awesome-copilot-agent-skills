...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/green-claims-review.zip)** (one zip, ready for Agent Builder) · Category: `risk-ethics-compliance` · Skill name: `green-claims-review`
