...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/software-request-review.zip)** (one zip, ready for Agent Builder) · Category: `it-operations` · Skill name: `software-request-review`
