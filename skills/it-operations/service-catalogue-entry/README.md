...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/service-catalogue-entry.zip)** (one zip, ready for Agent Builder) · Category: `it-operations` · Skill name: `service-catalogue-entry`
