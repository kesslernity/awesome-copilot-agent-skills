...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/inbox-triage.zip)** (one zip, ready for Agent Builder) · Category: `email-inbox` · Skill name: `inbox-triage`
