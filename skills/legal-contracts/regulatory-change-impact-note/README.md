...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/regulatory-change-impact-note.zip)** (one zip, ready for Agent Builder) · Category: `legal-contracts` · Skill name: `regulatory-change-impact-note`
