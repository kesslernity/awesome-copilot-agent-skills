...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/contract-review-pack.zip)** (one zip, ready for Agent Builder) · Category: `legal-contracts` · Skill name: `contract-review-pack`
