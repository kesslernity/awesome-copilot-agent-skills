...
**[Download the upload package](https://github.com/kesslernity/awesome-copilot-agent-skills/raw/main/dist/zips/estimate-to-sow.zip)** (one zip, ready for Agent Builder) · Category: `sales-bd` · Skill name: `estimate-to-sow`
