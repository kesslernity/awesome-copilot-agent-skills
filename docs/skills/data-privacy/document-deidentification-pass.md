...
Category: `data-privacy` · Skill name: `document-deidentification-pass` · Upload package: `dist/zips/document-deidentification-pass.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/document-deidentification-pass.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
