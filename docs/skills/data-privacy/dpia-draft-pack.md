...
Category: `data-privacy` · Skill name: `dpia-draft-pack` · Upload package: `dist/zips/dpia-draft-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/dpia-draft-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
