...
Category: `quality-audit` · Skill name: `nonconformance-report-drafter` · Upload package: `dist/zips/nonconformance-report-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/nonconformance-report-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
