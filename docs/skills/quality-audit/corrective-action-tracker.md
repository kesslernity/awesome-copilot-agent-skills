...
Category: `quality-audit` · Skill name: `corrective-action-tracker` · Upload package: `dist/zips/corrective-action-tracker.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/corrective-action-tracker.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
