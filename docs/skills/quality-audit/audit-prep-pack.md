...
Category: `quality-audit` · Skill name: `audit-prep-pack` · Upload package: `dist/zips/audit-prep-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/audit-prep-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
