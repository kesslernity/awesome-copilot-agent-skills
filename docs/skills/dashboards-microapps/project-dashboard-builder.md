...
Category: `dashboards-microapps` · Skill name: `project-dashboard-builder` · Upload package: `dist/zips/project-dashboard-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/project-dashboard-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
