...
Category: `risk-ethics-compliance` · Skill name: `controls-gap-pack` · Upload package: `dist/zips/controls-gap-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/controls-gap-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
