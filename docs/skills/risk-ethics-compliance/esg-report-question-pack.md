...
Category: `risk-ethics-compliance` · Skill name: `esg-report-question-pack` · Upload package: `dist/zips/esg-report-question-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/esg-report-question-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
