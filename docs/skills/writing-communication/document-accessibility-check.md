...
Category: `writing-communication` · Skill name: `document-accessibility-check` · Upload package: `dist/zips/document-accessibility-check.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/document-accessibility-check.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
