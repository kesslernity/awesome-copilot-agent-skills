...
Category: `writing-communication` · Skill name: `write-like-me` · Upload package: `dist/zips/write-like-me.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/write-like-me.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
