...
Category: `writing-communication` · Skill name: `branded-deck-builder` · Upload package: `dist/zips/branded-deck-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/branded-deck-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
