...
Category: `writing-communication` · Skill name: `claims-evidence-map` · Upload package: `dist/zips/claims-evidence-map.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/claims-evidence-map.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
