...
Category: `meta-skills` · Skill name: `skill-file-reviewer` · Upload package: `dist/zips/skill-file-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/skill-file-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
