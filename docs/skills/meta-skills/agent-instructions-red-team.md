...
Category: `meta-skills` · Skill name: `agent-instructions-red-team` · Upload package: `dist/zips/agent-instructions-red-team.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/agent-instructions-red-team.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
