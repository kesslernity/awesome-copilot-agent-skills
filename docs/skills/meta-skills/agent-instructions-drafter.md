...
Category: `meta-skills` · Skill name: `agent-instructions-drafter` · Upload package: `dist/zips/agent-instructions-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/agent-instructions-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
