...
Category: `meta-skills` · Skill name: `agent-evaluation-plan` · Upload package: `dist/zips/agent-evaluation-plan.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/agent-evaluation-plan.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
