...
Category: `daily-briefings` · Skill name: `custom-daily-brief` · Upload package: `dist/zips/custom-daily-brief.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/custom-daily-brief.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
