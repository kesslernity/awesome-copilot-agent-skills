...
Category: `daily-briefings` · Skill name: `commitment-catcher` · Upload package: `dist/zips/commitment-catcher.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/commitment-catcher.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
