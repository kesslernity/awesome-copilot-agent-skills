...
Category: `marketing-communications` · Skill name: `case-study-drafter` · Upload package: `dist/zips/case-study-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/case-study-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
