...
Category: `marketing-communications` · Skill name: `message-house-builder` · Upload package: `dist/zips/message-house-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/message-house-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
