...
Category: `marketing-communications` · Skill name: `content-calendar-planner` · Upload package: `dist/zips/content-calendar-planner.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/content-calendar-planner.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
