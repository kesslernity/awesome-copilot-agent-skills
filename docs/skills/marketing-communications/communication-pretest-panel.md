...
Category: `marketing-communications` · Skill name: `communication-pretest-panel` · Upload package: `dist/zips/communication-pretest-panel.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/communication-pretest-panel.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
