...
Category: `marketing-communications` · Skill name: `internal-newsletter-drafter` · Upload package: `dist/zips/internal-newsletter-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/internal-newsletter-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
