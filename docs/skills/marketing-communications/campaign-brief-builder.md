...
Category: `marketing-communications` · Skill name: `campaign-brief-builder` · Upload package: `dist/zips/campaign-brief-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/campaign-brief-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
