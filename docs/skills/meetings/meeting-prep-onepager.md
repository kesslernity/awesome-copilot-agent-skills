...
Category: `meetings` · Skill name: `meeting-prep-onepager` · Upload package: `dist/zips/meeting-prep-onepager.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/meeting-prep-onepager.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
