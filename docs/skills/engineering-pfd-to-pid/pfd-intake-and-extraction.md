...
Category: `engineering-pfd-to-pid` · Skill name: `pfd-intake-and-extraction` · Upload package: `dist/zips/pfd-intake-and-extraction.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/pfd-intake-and-extraction.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
