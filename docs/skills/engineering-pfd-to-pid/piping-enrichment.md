...
Category: `engineering-pfd-to-pid` · Skill name: `piping-enrichment` · Upload package: `dist/zips/piping-enrichment.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/piping-enrichment.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
