...
Category: `engineering-pfd-to-pid` · Skill name: `instrumentation-and-control-enrichment` · Upload package: `dist/zips/instrumentation-and-control-enrichment.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/instrumentation-and-control-enrichment.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
