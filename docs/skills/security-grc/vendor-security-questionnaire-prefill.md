...
Category: `security-grc` · Skill name: `vendor-security-questionnaire-prefill` · Upload package: `dist/zips/vendor-security-questionnaire-prefill.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/vendor-security-questionnaire-prefill.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
