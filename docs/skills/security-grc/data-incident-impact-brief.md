...
Category: `security-grc` · Skill name: `data-incident-impact-brief` · Upload package: `dist/zips/data-incident-impact-brief.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/data-incident-impact-brief.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
