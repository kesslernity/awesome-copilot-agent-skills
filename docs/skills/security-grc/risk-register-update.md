...
Category: `security-grc` · Skill name: `risk-register-update` · Upload package: `dist/zips/risk-register-update.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/risk-register-update.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
