...
Category: `security-grc` · Skill name: `control-evidence-request-pack` · Upload package: `dist/zips/control-evidence-request-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/control-evidence-request-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
