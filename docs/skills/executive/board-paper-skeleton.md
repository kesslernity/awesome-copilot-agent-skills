...
Category: `executive` · Skill name: `board-paper-skeleton` · Upload package: `dist/zips/board-paper-skeleton.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/board-paper-skeleton.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
