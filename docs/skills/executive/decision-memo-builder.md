...
Category: `executive` · Skill name: `decision-memo-builder` · Upload package: `dist/zips/decision-memo-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/decision-memo-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
