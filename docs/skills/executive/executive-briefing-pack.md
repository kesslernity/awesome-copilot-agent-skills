...
Category: `executive` · Skill name: `executive-briefing-pack` · Upload package: `dist/zips/executive-briefing-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/executive-briefing-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
