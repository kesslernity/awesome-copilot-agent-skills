...
Category: `executive` · Skill name: `architecture-decision-record` · Upload package: `dist/zips/architecture-decision-record.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/architecture-decision-record.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
