...
Category: `finance` · Skill name: `expense-policy-precheck` · Upload package: `dist/zips/expense-policy-precheck.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/expense-policy-precheck.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
