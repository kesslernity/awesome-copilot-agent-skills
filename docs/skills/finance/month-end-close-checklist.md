...
Category: `finance` · Skill name: `month-end-close-checklist` · Upload package: `dist/zips/month-end-close-checklist.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/month-end-close-checklist.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
