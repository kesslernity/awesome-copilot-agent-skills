...
Category: `finance` · Skill name: `capex-request-pack` · Upload package: `dist/zips/capex-request-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/capex-request-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
