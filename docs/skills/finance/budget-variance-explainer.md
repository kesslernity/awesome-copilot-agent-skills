...
Category: `finance` · Skill name: `budget-variance-explainer` · Upload package: `dist/zips/budget-variance-explainer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/budget-variance-explainer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
