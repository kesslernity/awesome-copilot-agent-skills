...
Category: `it-operations` · Skill name: `incident-postmortem-drafter` · Upload package: `dist/zips/incident-postmortem-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/incident-postmortem-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
