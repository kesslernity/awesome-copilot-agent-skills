...
Category: `it-operations` · Skill name: `knowledge-base-hygiene-review` · Upload package: `dist/zips/knowledge-base-hygiene-review.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/knowledge-base-hygiene-review.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
