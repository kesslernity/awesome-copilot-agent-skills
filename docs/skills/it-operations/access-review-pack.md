...
Category: `it-operations` · Skill name: `access-review-pack` · Upload package: `dist/zips/access-review-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/access-review-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
