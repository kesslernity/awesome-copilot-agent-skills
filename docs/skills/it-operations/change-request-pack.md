...
Category: `it-operations` · Skill name: `change-request-pack` · Upload package: `dist/zips/change-request-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/change-request-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
