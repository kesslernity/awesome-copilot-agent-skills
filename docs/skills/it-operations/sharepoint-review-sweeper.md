...
Category: `it-operations` · Skill name: `sharepoint-review-sweeper` · Upload package: `dist/zips/sharepoint-review-sweeper.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/sharepoint-review-sweeper.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
