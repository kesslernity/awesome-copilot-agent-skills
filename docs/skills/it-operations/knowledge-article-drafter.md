...
Category: `it-operations` · Skill name: `knowledge-article-drafter` · Upload package: `dist/zips/knowledge-article-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/knowledge-article-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
