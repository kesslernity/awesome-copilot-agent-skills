...
Category: `hr-people` · Skill name: `onboarding-plan-builder` · Upload package: `dist/zips/onboarding-plan-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/onboarding-plan-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
