...
Category: `hr-people` · Skill name: `change-communication-plan` · Upload package: `dist/zips/change-communication-plan.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/change-communication-plan.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
