...
Category: `hr-people` · Skill name: `policy-question-answerer` · Upload package: `dist/zips/policy-question-answerer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/policy-question-answerer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
