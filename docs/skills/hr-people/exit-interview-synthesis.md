...
Category: `hr-people` · Skill name: `exit-interview-synthesis` · Upload package: `dist/zips/exit-interview-synthesis.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/exit-interview-synthesis.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
