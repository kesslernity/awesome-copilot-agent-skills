...
Category: `hr-people` · Skill name: `policy-change-briefing` · Upload package: `dist/zips/policy-change-briefing.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/policy-change-briefing.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
