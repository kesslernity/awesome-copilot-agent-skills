...
Category: `hr-people` · Skill name: `interview-scorecard-builder` · Upload package: `dist/zips/interview-scorecard-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/interview-scorecard-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
