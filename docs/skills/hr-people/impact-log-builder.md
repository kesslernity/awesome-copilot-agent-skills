...
Category: `hr-people` · Skill name: `impact-log-builder` · Upload package: `dist/zips/impact-log-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/impact-log-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
