...
Category: `hr-people` · Skill name: `job-description-drafter` · Upload package: `dist/zips/job-description-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/job-description-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
