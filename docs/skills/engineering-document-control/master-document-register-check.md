...
Category: `engineering-document-control` · Skill name: `master-document-register-check` · Upload package: `dist/zips/master-document-register-check.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/master-document-register-check.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
