...
Category: `data-analytics` · Skill name: `dataset-insight-pack` · Upload package: `dist/zips/dataset-insight-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/dataset-insight-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
