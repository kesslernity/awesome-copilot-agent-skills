...
Category: `product-management` · Skill name: `product-requirements-draft` · Upload package: `dist/zips/product-requirements-draft.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/product-requirements-draft.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
