...
Category: `product-management` · Skill name: `user-personas-builder` · Upload package: `dist/zips/user-personas-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/user-personas-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
