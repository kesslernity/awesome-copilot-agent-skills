...
Category: `operations` · Skill name: `request-intake-triage` · Upload package: `dist/zips/request-intake-triage.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/request-intake-triage.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
