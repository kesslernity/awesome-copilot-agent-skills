...
Category: `operations` · Skill name: `sop-drafter` · Upload package: `dist/zips/sop-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/sop-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
