...
Category: `sales-bd` · Skill name: `lead-qualification-scorer` · Upload package: `dist/zips/lead-qualification-scorer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/lead-qualification-scorer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
