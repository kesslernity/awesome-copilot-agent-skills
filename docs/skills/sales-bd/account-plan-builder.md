...
Category: `sales-bd` · Skill name: `account-plan-builder` · Upload package: `dist/zips/account-plan-builder.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/account-plan-builder.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
