...
Category: `sales-bd` · Skill name: `discovery-call-prep` · Upload package: `dist/zips/discovery-call-prep.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/discovery-call-prep.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
