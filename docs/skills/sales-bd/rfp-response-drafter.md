...
Category: `sales-bd` · Skill name: `rfp-response-drafter` · Upload package: `dist/zips/rfp-response-drafter.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/rfp-response-drafter.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
