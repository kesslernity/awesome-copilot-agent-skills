...
Category: `procurement` · Skill name: `purchase-order-anomaly-review` · Upload package: `dist/zips/purchase-order-anomaly-review.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/purchase-order-anomaly-review.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
