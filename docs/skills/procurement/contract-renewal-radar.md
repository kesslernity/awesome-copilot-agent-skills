...
Category: `procurement` · Skill name: `contract-renewal-radar` · Upload package: `dist/zips/contract-renewal-radar.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/contract-renewal-radar.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
