...
Category: `procurement` · Skill name: `supplier-evaluation-matrix` · Upload package: `dist/zips/supplier-evaluation-matrix.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/supplier-evaluation-matrix.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
