...
Category: `procurement` · Skill name: `rfp-requirements-pack` · Upload package: `dist/zips/rfp-requirements-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/rfp-requirements-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
