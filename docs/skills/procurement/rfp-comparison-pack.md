...
Category: `procurement` · Skill name: `rfp-comparison-pack` · Upload package: `dist/zips/rfp-comparison-pack.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/rfp-comparison-pack.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
