...
Category: `legal-contracts` · Skill name: `nda-triage` · Upload package: `dist/zips/nda-triage.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/nda-triage.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
