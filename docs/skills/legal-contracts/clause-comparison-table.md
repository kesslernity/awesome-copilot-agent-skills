...
Category: `legal-contracts` · Skill name: `clause-comparison-table` · Upload package: `dist/zips/clause-comparison-table.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/clause-comparison-table.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
