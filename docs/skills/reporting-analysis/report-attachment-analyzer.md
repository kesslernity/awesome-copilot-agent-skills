...
Category: `reporting-analysis` · Skill name: `report-attachment-analyzer` · Upload package: `dist/zips/report-attachment-analyzer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/report-attachment-analyzer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
