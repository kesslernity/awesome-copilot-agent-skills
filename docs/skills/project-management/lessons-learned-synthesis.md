...
Category: `project-management` · Skill name: `lessons-learned-synthesis` · Upload package: `dist/zips/lessons-learned-synthesis.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/lessons-learned-synthesis.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
