...
Category: `project-management` · Skill name: `raid-log-review` · Upload package: `dist/zips/raid-log-review.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/raid-log-review.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
