...
Category: `project-management` · Skill name: `project-status-tracker` · Upload package: `dist/zips/project-status-tracker.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/project-status-tracker.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
