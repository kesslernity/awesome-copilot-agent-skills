...
Category: `executive-review` · Skill name: `cfo-reviewer` · Upload package: `dist/zips/cfo-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/cfo-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
