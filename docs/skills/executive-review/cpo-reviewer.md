...
Category: `executive-review` · Skill name: `cpo-reviewer` · Upload package: `dist/zips/cpo-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/cpo-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
