...
Category: `executive-review` · Skill name: `frontline-skeptic-reviewer` · Upload package: `dist/zips/frontline-skeptic-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/frontline-skeptic-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
