...
Category: `executive-review` · Skill name: `chro-reviewer` · Upload package: `dist/zips/chro-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/chro-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
