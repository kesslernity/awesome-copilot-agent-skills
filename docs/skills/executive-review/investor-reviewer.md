...
Category: `executive-review` · Skill name: `investor-reviewer` · Upload package: `dist/zips/investor-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/investor-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
