...
Category: `executive-review` · Skill name: `cdo-reviewer` · Upload package: `dist/zips/cdo-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/cdo-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
