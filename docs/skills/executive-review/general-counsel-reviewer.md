...
Category: `executive-review` · Skill name: `general-counsel-reviewer` · Upload package: `dist/zips/general-counsel-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/general-counsel-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
