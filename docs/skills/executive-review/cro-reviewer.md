...
Category: `executive-review` · Skill name: `cro-reviewer` · Upload package: `dist/zips/cro-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/cro-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
