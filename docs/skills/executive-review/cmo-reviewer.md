...
Category: `executive-review` · Skill name: `cmo-reviewer` · Upload package: `dist/zips/cmo-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/cmo-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
