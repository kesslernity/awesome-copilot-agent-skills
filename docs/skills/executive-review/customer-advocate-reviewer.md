...
Category: `executive-review` · Skill name: `customer-advocate-reviewer` · Upload package: `dist/zips/customer-advocate-reviewer.zip`
...
2. **Configure**, expand **Skills**, **Add**, upload `dist/zips/customer-advocate-reviewer.zip` (the whole zip, never `SKILL.md` alone). Up to eight skills per agent.
